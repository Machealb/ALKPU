...
color_list = ["#008000", "#080000", "#000000", "#A52A2A"]
mark_list = [".", ",", "v", "^", "+", "o", '*']
...
def draw_lines(x_list:list, y_list :list, axvlines: list, \
    ...
    for i in range(len(y2_list)):
        plt.plot(x2_list[i], y2_list[i], color="#800000", \
                    linewidth =3.0)
    ...
    kpu_line = mlines.Line2D([], [], color='#800000', linestyle='solid',linewidth=5)

    # 设置图例的字体大小和颜色，以及自定义图例对象和标签
    plt.legend(handles=[dft_line,  kpu_line], \
               labels=['DFT', 'ALKPU'], fontsize=20)#, framealpha=0, frameon=False, loc=location
    plt.tight_layout()
...
def draw_band(dft_data_path, kpu_data_path, save_path, system):
    ...
    draw_lines(x_dft, y_dft, axv_dft, x_kpu, y_kpu, axv_kpu, legend_label = None, \
        x_label = None, y_label = "Frequency (THz)", xticks=xticks, \
        title = "Phonon spectra of {} system".format(system), location = "lower center", \
...
if __name__ =="__main__":
    ...
    # save_path = "/share/home/wuxingxing/al_dir/si/final/phy/phonopy/phonon_si.png" 
    # draw_band(dft_data_path, kpu_data_path, save_path, system="Si")
    ...
    # Al
    # dft_data_path = "/share/home/wuxingxing/al_dir/al/final/phy/phonopy/dft_al_big/phonon_std/band.dat"
    # kpu_data_path = "/share/home/wuxingxing/al_dir/al/final/phy/phonopy/kpu_al_big/phonon_std/band.dat"
    # save_path = "/share/home/wuxingxing/al_dir/al/final/phy/phonopy/phonon_al_big.png" 
    # draw_band(dft_data_path, kpu_data_path, save_path, system="Al")

    # ni
    # dft_data_path = "/share/home/wuxingxing/al_dir/ni/final/phy/phonopy/dft_ni/phonon_std/band.dat"
    # kpu_data_path = "/share/home/wuxingxing/al_dir/ni/final/phy/phonopy/kpu_ni/phonon_std/band.dat"
    # save_path = "/share/home/wuxingxing/al_dir/ni/final/phy/phonopy/phonon_ni.png" 
    # draw_band(dft_data_path, kpu_data_path, save_path, system="Ni")